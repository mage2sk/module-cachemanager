<?php
/**
 * Standalone install + heartbeat reporter for Panth_CacheManager.
 *
...
namespace Panth\CacheManager\Service;
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_CacheManager';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-cachemanager';
